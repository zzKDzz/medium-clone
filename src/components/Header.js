...
class Header extends Component{
  ...
  render(){
    // const openSignInWith = () => { dispatch({type: 'TOGGLE_MODAL', modalMode: true}) }
          ...
          <div className="container-fluid col-md-10 col-md-offset-1">
            ...
            <div className="folding-nav">
              <ul className="nav navbar-nav navbar-right">
                ...
                {this.props.isAuth ? '' : <li onClick={toggleOpen} className="sign-in-button"><a className="button green-border-button" data-behavior="trigger-overlay" href="#">Sign in / Sign up</a></li>}
              </ul>
            </div>
          </div>
        </nav>
